...
- [📖 The TransactionWeb ](#-the-budget-app-)
...
- [Explanatory Video](https://www.loom.com)
...
sh <br>
cd my-folder <br>
git clone https://github.com/francksefu/transaction-web.git
...
Feel free to check the [issues page](https://github.com/francksefu/transaction-web/issues).
